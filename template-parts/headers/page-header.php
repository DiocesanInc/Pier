...
//     } else {
//         $headerImg = getDefaultFeaturedImage(true) ? getDefaultFeaturedImage(true) : get_stylesheet_directory_uri() . "/assets/img/pier_placeholder.png";
//     }
// }
...
<div class="entry-header page-header" xstyle="background-image: url(<?php echo $headerImg; ?>)">
    <?php echo $headline; ?>
